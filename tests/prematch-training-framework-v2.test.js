...
test('canonical runtime publishes v2 framework and live UI v5',()=>{assert.equal(TRAINING_RUNTIME_VERSIONS.framework,2);assert.equal(TRAINING_RUNTIME_VERSIONS.roleScenarios,1);assert.equal(TRAINING_RUNTIME_VERSIONS.liveUi,5);});

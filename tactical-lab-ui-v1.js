...
export function editorMarkup(){
  return `<section class="tlab-shell">
    <div class="hero tlab-hero"><div><div class="eyebrow">PIZARRA</div><h1>Dibujá la jugada</h1><p>Elegí un jugador y marcá carreras, pases, centros, remates o posiciones. El motor lo interpreta según el contexto del partido.</p></div><div class="actions"><button class="btn ghost" id="tlab-clear">Limpiar</button><button class="btn" id="tlab-save">Guardar jugada</button></div></div>
